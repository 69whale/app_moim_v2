...
import org.edupoll.model.dto.response.Pagenation;
...
public class MoimService {
	...
	// 페이지 정보 만들어주는 서비스 메서드
		public Pagenation createPagenation(int currentValue) {
...
//			PageItem prev = (startValue == 1) ? new PageItem(-1, false) : new PageItem(startValue, true);
			...
			Pagenation pagenation = new Pagenation(prev, next, li);
...
//	//모임 생성
//	public boolean createNewMoim(Moim moim, String id) {
//		moim.setManagerId(id);
//
...
//	//모임 리스트
//	public List<Moim> getMoimsInSpecificPage(int pageNo) {
//		PageRequest pageRequest= PageRequest.of(pageNo, 12, Sort.by(Direction.ASC, "targetDate"));
//		return moimRepository.findAll(pageRequest).toList();
//	}
